...
import com.webeservice.example.restfulServices.entites.Views;
...
public class UserJsonViewController {
	...
	public Optional<User> getUserByIdExtrnl(@PathVariable("id") @Min(1) Long id) {
	...
	public Optional<User> getUserByIdIntrnl(@PathVariable("id") @Min(1) Long id) {
